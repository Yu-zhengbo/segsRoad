...
from mmseg.models.backbones.mamba.vmamba.csm_triton import cross_scan_fn, cross_merge_fn
from mmseg.models.backbones.mamba.vmamba.csms6s import selective_scan_fn, selective_scan_flop_jit
from mmseg.models.backbones.damamba import Dynamic_Adaptive_Scan
# try:
...
from mmseg.models.backbones.mamba.vmamba.mamba2.ssd_minimal import selective_scan_chunk_fn
...
class SS2Dv2:
    def __initv2__(
        ...
        **kwargs,    
        ...
        self.dscan = Dynamic_Adaptive_Scan(channels=self.d_inner,group=d_model//16)
    ...
    def forwardv2(self, x: torch.Tensor, **kwargs):
        ...
        x=self.dscan(input,x.permute(0, 2,3,1).contiguous())
...
class DeformableAggregateVMAMBA(VSSM):
