...
from mmseg.models.backbones.mamba.globalmamba.rope import *
import random
...
def GlobalMambaTiny(pretrained=False, **kwargs):
    model = VisionMamba(
...
@MODELS_MMSEG.register_module()
def GlobalMambaTiny_stride8(pretrained=False, **kwargs):
    model = VisionMamba(
...
@MODELS_MMSEG.register_module()
def GlobalMambaSmall(pretrained=False, **kwargs):
    model = VisionMamba(
...
@MODELS_MMSEG.register_module()
def GlobalMambaSmall_stride8(pretrained=False, **kwargs):
    model = VisionMamba(
