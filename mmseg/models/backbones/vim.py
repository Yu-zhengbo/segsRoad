...
from mmseg.models.backbones.mamba.visiomamba import VisionMamba
...
class VisionMambaSeg(VisionMamba):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(img_size, patch_size, stride, depth, embed_dim, channels=in_chans, num_classes=num_classes, **kwargs)
